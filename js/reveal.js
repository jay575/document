...
(function( root, factory ) {
	...
	function setupDOM() {
		...
		createSingletonNode( dom.wrapper, 'aside', 'controls',
			'<button class="navigate-left" aria-label="previous slide" style="background: url(controls/left.png); background-color: #fff;"></button>' +
			'<button class="navigate-right" aria-label="next slide" style="background: url(controls/right.png); background-color: #fff;"></button>' +
			'<button class="navigate-up" aria-label="above slide" style="background: url(controls/up.png); background-color: #fff;"></button>' +
			'<button class="navigate-down" aria-label="below slide" style="background: url(controls/down.png); background-color: #fff;"></button>' );
